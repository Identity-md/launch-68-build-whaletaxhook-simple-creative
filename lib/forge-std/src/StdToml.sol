...
library stdToml {
    ...
    function readUintArray(string memory toml, string memory key)
        internal
        pure
    ...
    function readIntArray(string memory toml, string memory key)
        internal
        pure
    ...
    function readBytes32Array(string memory toml, string memory key)
        internal
        pure
    ...
    function readStringArray(string memory toml, string memory key)
        internal
        pure
        returns (string[] memory)
    {
    ...
    function readAddressArray(string memory toml, string memory key)
        internal
        pure
    ...
    function readBoolArray(string memory toml, string memory key)
        internal
        pure
        returns (bool[] memory)
    {
    ...
    function readBytesArray(string memory toml, string memory key)
        internal
        pure
    ...
    function readUintOr(string memory toml, string memory key, uint256 defaultValue)
        internal
        view
        returns (uint256)
    {
    ...
    function readIntOr(string memory toml, string memory key, int256 defaultValue)
        internal
        view
        returns (int256)
    {
    ...
    function readBoolOr(string memory toml, string memory key, bool defaultValue)
        internal
        view
        returns (bool)
    {
    ...
    function serialize(string memory jsonKey, string memory rootObject)
        internal
        returns (string memory)
    {

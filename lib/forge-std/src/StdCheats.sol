...
abstract contract StdCheatsSafe {
    ...
    function assumeAddressIsNot(address addr, AddressType addressType1, AddressType addressType2)
        internal
        virtual
    {
        ...
        returns (EIP1559ScriptArtifact memory)
    {
        ...
        RawEIP1559ScriptArtifact memory rawArtifact =
            abi.decode(parsedData, (RawEIP1559ScriptArtifact));
        ...
        returns (address addr)
    {
        ...
        require(
            addr != address(0), "StdCheats deployCode(string,bytes,uint256): Deployment failed."
        );
    }
...
abstract contract StdCheats is StdCheatsSafe {
    ...
    function dealERC1155(address token, address to, uint256 id, uint256 give, bool adjust)
        internal
        virtual
    {
        // get current balance
    ...
    function dealERC721(address token, address to, uint256 id) internal virtual {
        ...
        stdstore.target(token)
            .sig(0x70a08231)
            .with_key(abi.decode(ownerData, (address)))

...
contract ProtocolFeesTest is Test, Deployers {
    ...
    function test_setProtocolFee_revertsWithInvalidFee() public {
        ...
        vm.prank(feeController);
        vm.expectRevert(
            abi.encodeWithSelector(IProtocolFees.ProtocolFeeTooLarge.selector, protocolFee)
        );
    ...
    function test_fuzz_collectProtocolFees(address recipient, uint256 amount, uint256 feesAccrued)
        public
    {

...
contract LiquidityMathRef {
    ...
    {
        liquidityNet =
            upper ? liquidityNetBefore - liquidityDelta : liquidityNetBefore + liquidityDelta;
    }
}
...
contract TickTest is Test {
    ...
    function testTick_tickSpacingToMaxLiquidityPerTick_returnsTheCorrectValueForLowFee()
        public
        pure
    {
    ...
    function testTick_tickSpacingToMaxLiquidityPerTick_returnsTheCorrectValueForMediumFee()
        public
        pure
    {
    ...
    function testTick_tickSpacingToMaxLiquidityPerTick_returnsTheCorrectValueForHighFee()
        public
        pure
    {
    ...
    function testTick_tickSpacingToMaxLiquidityPerTick_returnsTheCorrectValueForMinTickSpacing()
        public
        pure
    {
    ...
    function testTick_tickSpacingToMaxLiquidityPerTick_returnsTheCorrectValueForMaxTickSpacing()
        public
        pure
    {
    ...
    function testTick_tickSpacingToMaxLiquidityPerTick_returnsTheCorrectValueForEntireRange()
        public
        pure
    {
    ...
    function testTick_getFeeGrowthInside_returns0ForTwoUninitializedTicksIfTickIsAbove() public {
        (uint256 feeGrowthInside0X128, uint256 feeGrowthInside1X128) =
            getFeeGrowthInside(-2, 2, 4, 15, 15);
    ...
    function testTick_update_liquidityParsing_parsesMaxUint128StoredLiquidityGrossBeforeUpdate()
        public
    {
        Pool.TickInfo memory info;
    ...
    function testTick_update_liquidityParsing_parsesMaxUint128StoredLiquidityGrossAfterUpdate()
        public
    {
        Pool.TickInfo memory info;
    ...
    function testTick_update_liquidityParsing_parsesMaxInt128StoredLiquidityGrossBeforeUpdate()
        public
    {
        Pool.TickInfo memory info;
    ...
    function testTick_update_liquidityParsing_parsesMaxInt128StoredLiquidityGrossAfterUpdate()
        public
    {
        Pool.TickInfo memory info;
    ...
    function testTick_update_fuzz(
        uint128 liquidityGross,
        int128 liquidityNet,
        int128 liquidityDelta,
        bool upper
    ) public {
        try liquidityMath.addDelta(liquidityGross, liquidityDelta) returns (
            uint128 liquidityGrossAfter
        ) {
            try liquidityMath.addDelta(upper, liquidityNet, liquidityDelta) returns (
                int128 liquidityNetAfter
            ) {

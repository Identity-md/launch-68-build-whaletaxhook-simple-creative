...
contract StateLibraryTest is Test, Deployers, Fuzzers {
    ...
    function test_getTickLiquidity() public {
        modifyLiquidityRouter.modifyLiquidity(
            key, ModifyLiquidityParams(-60, 60, 10 ether, 0), ZERO_BYTES
        );
    ...
    function test_fuzz_getTickLiquidity(ModifyLiquidityParams memory params) public {
        (ModifyLiquidityParams memory _params,) = Fuzzers.createFuzzyLiquidity(
            modifyLiquidityRouter, key, params, SQRT_PRICE_1_1, ZERO_BYTES
        );
    ...
    function test_fuzz_getTickLiquidity_two_positions(
        ...
        if (_paramsA.tickLower == _paramsB.tickLower || _paramsA.tickLower == _paramsB.tickUpper) {
            ...
            (_paramsA.tickLower == _paramsB.tickLower)
                ...
                : assertApproxEqAbs(
                    liquidityNetLowerA, int128(liquidityDeltaA) - int128(liquidityDeltaB), 1 wei
                );
        } else {
        ...
        if (_paramsA.tickUpper == _paramsB.tickLower || _paramsA.tickUpper == _paramsB.tickUpper) {
            ...
            (_paramsA.tickUpper == _paramsB.tickUpper)
                ...
                : assertApproxEqAbs(
                    liquidityNetUpperA, int128(liquidityDeltaB) - int128(liquidityDeltaA), 2 wei
                );
        } else {
        ...
        if (_paramsB.tickLower == _paramsA.tickLower || _paramsB.tickLower == _paramsA.tickUpper) {
            ...
            (_paramsB.tickLower == _paramsA.tickLower)
                ...
                : assertApproxEqAbs(
                    liquidityNetLowerB, int128(liquidityDeltaB) - int128(liquidityDeltaA), 1 wei
                );
        } else {
        ...
        if (_paramsB.tickUpper == _paramsA.tickLower || _paramsB.tickUpper == _paramsA.tickUpper) {
            ...
            (_paramsB.tickUpper == _paramsA.tickUpper)
                ...
                : assertApproxEqAbs(
                    liquidityNetUpperB, int128(liquidityDeltaA) - int128(liquidityDeltaB), 2 wei
                );
        } else {
    ...
    function test_getFeeGrowthGlobals0() public {
        ...
        uint256 feeGrowthGlobalCalc =
            swapAmount.mulWadDown(0.003e18).mulDivDown(FixedPoint128.Q128, liquidity);
    ...
    function test_fuzz_getTickBitmap(ModifyLiquidityParams memory params) public {
        ...
        (int16 wordPosUpper, uint8 bitPosUpper) =
            TickBitmap.position(_params.tickUpper / key.tickSpacing);
    ...
    function test_getPositionInfo() public {
        ...
        bytes32 positionId = keccak256(
            abi.encodePacked(address(modifyLiquidityRouter), int24(-60), int24(60), bytes32(0))
        );
    ...
    function test_fuzz_getPositionInfo(
        ...
        (ModifyLiquidityParams memory _params, BalanceDelta delta) = createFuzzyLiquidity(
            modifyLiquidityRouter, key, params, SQRT_PRICE_1_1, ZERO_BYTES
        );
    ...
    function test_getTickInfo() public {
        ...
        (uint128 liquidityGross_, int128 liquidityNet_) =
            StateLibrary.getTickLiquidity(manager, poolId, tick);
    ...
    function test_fuzz_getFeeGrowthInside(ModifyLiquidityParams memory params, bool zeroForOne)
        public
    {
        modifyLiquidityRouter.modifyLiquidity(
            key,

...
contract SwapMathTest is Test {
    function test_fuzz_getSqrtPriceTarget(
        bool zeroForOne,
    ...
    function test_computeSwapStep_exactAmountIn_oneForZero_thatGetsCappedAtPriceTargetIn()
        public
        pure
    {
        ...
        uint256 priceAfterWholeInputAmount = SqrtPriceMath.getNextSqrtPriceFromInput(
            price, liquidity, uint256(amount * -1), zeroForOne
        );
    ...
    function test_computeSwapStep_exactAmountOut_oneForZero_thatGetsCappedAtPriceTargetIn()
        public
        pure
    {
        uint160 priceTarget = Constants.SQRT_PRICE_101_100;
    ...
    function test_computeSwapStep_exactAmountIn_oneForZero_thatIsFullySpentIn() public pure {
        ...
        uint256 priceAfterWholeInputAmountLessFee = SqrtPriceMath.getNextSqrtPriceFromInput(
            price, liquidity, uint256(uint256(-amount) - feeAmount), zeroForOne
        );
    ...
    function test_computeSwapStep_zeroForOne_handlesIntermediateInsufficientLiquidityInExactOutputCase()
        public
        pure
    {
    ...
    function test_computeSwapStep_oneForZero_handlesIntermediateInsufficientLiquidityInExactOutputCase()
        public
        pure
    {
        uint160 sqrtP = 20282409603651670423947251286016;
    ...
    function test_fuzz_computeSwapStep(
        ...
        (uint160 sqrtQ, uint256 amountIn, uint256 amountOut, uint256 feeAmount) = SwapMath.computeSwapStep(
            sqrtPriceRaw, sqrtPriceTargetRaw, liquidity, amountRemaining, feePips
        );
    ...
    function test_computeSwapStep_swapOneForZero_exactInCapped() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_101_100, 2 ether, (1 ether) * -1, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapZeroForOne_exactInCapped() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_99_100, 2 ether, (1 ether) * -1, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapOneForZero_exactOutCapped() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_101_100, 2 ether, 1 ether, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapZeroForOne_exactOutCapped() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_99_100, 2 ether, 1 ether, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapOneForZero_exactInPartial() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_1010_100, 2 ether, 1_000 * -1, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapZeroForOne_exactInPartial() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_99_1000, 2 ether, 1_000 * -1, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapOneForZero_exactOutPartial() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_1010_100, 2 ether, 1_000, 600
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_computeSwapStep_swapZeroForOne_exactOutPartial() public {
        ...
        SwapMath.computeSwapStep(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_99_1000, 2 ether, 1_000, 600
        );
        vm.stopSnapshotGas();
    }
}

...
contract TickBitmapTest is Test {
    ...
    function setUp() public {
        ...
        int24[10] memory ticks =
            [SOLO_INITIALIZED_TICK_IN_WORD, -200, -55, -4, INITIALIZED_TICK, 78, 84, 139, 240, 535];
    ...
    function test_fuzz_flipTick(int24 tick, int24 tickSpacing) public {
        ...
        if (tick % tickSpacing != 0) {
            vm.expectRevert(
                abi.encodeWithSelector(TickBitmap.TickMisaligned.selector, tick, tickSpacing)
            );
    ...
    function test_nextInitializedTickWithinOneWord_lteFalse_returnsTickToRightIfAtInitializedTick()
        public
        view
    {
    ...
    function test_nextInitializedTickWithinOneWord_lteFalse_returnsTickToRightIfAtInitializedTick2()
        public
        view
    {
    ...
    function test_nextInitializedTickWithinOneWord_lteFalse_returnsTheTickDirectlyToTheRight()
        public
        view
    {
    ...
    function test_nextInitializedTickWithinOneWord_lteFalse_returnsTheTickDirectlyToTheRight2()
        public
        view
    {
    ...
    function test_nextInitializedTickWithinOneWord_lteFalse_returnsTheNextInitializedTickFromTheNextWord()
        public
    {
        flipTick(340);
    ...
    function test_nextInitializedTickWithinOneWord_lteTrue_returnsSameTickIfInitialized()
        public
        view
    {
    ...
    function test_nextInitializedTickWithinOneWord_lteTrue_willNotExceedTheWordBoundary()
        public
        view
    {
    ...
    function test_fuzz_nextInitializedTickWithinOneWord_onEmptyBitmap(
        ...
        int24 nextInitializedTick =
            ((int24(wordPos) << 8) + int24(uint24(nextBitPos))) * tickSpacing;
        emptyBitmap.flipTick(nextInitializedTick, tickSpacing);
        (int24 next, bool initialized) =
            emptyBitmap.nextInitializedTickWithinOneWord(tick, tickSpacing, lte);
        assertEq(initialized, true);

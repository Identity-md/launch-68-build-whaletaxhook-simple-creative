...
contract HooksTest is Test, Deployers {
    ...
    function test_beforeAfterAddLiquidity_calledWithPositiveLiquidityDelta() public {
        ...
        MockERC20(Currency.unwrap(key.currency0)).approve(address(modifyLiquidityRouter), 1e18);
        modifyLiquidityRouter.modifyLiquidity(
            key, ModifyLiquidityParams(0, 60, 100, 0), new bytes(111)
        );
        assertEq(mockHooks.beforeAddLiquidityData(), new bytes(111));
        assertEq(mockHooks.afterAddLiquidityData(), new bytes(111));
    }
    ...
    function test_beforeAfterRemoveLiquidity_calledWithZeroLiquidityDelta() public {
        ...
        modifyLiquidityRouter.modifyLiquidity(
            key, ModifyLiquidityParams(0, 60, 0, 0), new bytes(222)
        );
        assertEq(mockHooks.beforeAddLiquidityData(), new bytes(111));
        assertEq(mockHooks.afterAddLiquidityData(), new bytes(111));
        assertEq(mockHooks.beforeRemoveLiquidityData(), new bytes(222));
    ...
    function test_beforeSwap_invalidReturn() public {
        ...
        swapRouter.swap(
            key,
            SwapParams(false, 100, SQRT_PRICE_1_1 + 60),
    ...
    function test_fuzz_validateHookPermissions_beforeAndAfterInitialize(uint160 addr) public view {
        ...
        IHooks hookAddr = IHooks(
            address(uint160(preAddr | Hooks.BEFORE_INITIALIZE_FLAG | Hooks.AFTER_INITIALIZE_FLAG))
        );
        Hooks.validateHookPermissions(
            hookAddr,
            Hooks.Permissions({
    ...
    function test_fuzz_validateHookPermissions_beforeAndAfterAddLiquidity(uint160 addr)
        public
        view
    {
        uint160 preAddr = addr & clearAllHookPermissionsMask;
        IHooks hookAddr = IHooks(
            address(
                uint160(preAddr | Hooks.BEFORE_ADD_LIQUIDITY_FLAG | Hooks.AFTER_ADD_LIQUIDITY_FLAG)
            )
        );
        Hooks.validateHookPermissions(
            hookAddr,
    ...
    function test_fuzz_validateHookPermissions_beforeAfterRemoveLiquidity(uint160 addr)
        public
        view
    {
        uint160 preAddr = addr & clearAllHookPermissionsMask;
        IHooks hookAddr = IHooks(
            address(
                uint160(
                    preAddr | Hooks.BEFORE_REMOVE_LIQUIDITY_FLAG | Hooks.AFTER_REMOVE_LIQUIDITY_FLAG
                )
            )
        );
        Hooks.validateHookPermissions(
    ...
    function test_fuzz_validateHookPermissions_beforeInitializeAfterAddLiquidity(uint160 addr)
        public
        view
    {
        uint160 preAddr = addr & clearAllHookPermissionsMask;
        IHooks hookAddr = IHooks(
            address(
                uint160(preAddr | Hooks.BEFORE_INITIALIZE_FLAG | Hooks.AFTER_ADD_LIQUIDITY_FLAG)
            )
        );
        Hooks.validateHookPermissions(
            hookAddr,
    ...
    function test_fuzz_validateHookPermissions_beforeAndAfterSwap(uint160 addr) public view {
        uint160 preAddr = addr & clearAllHookPermissionsMask;
        IHooks hookAddr =
            IHooks(address(uint160(preAddr | Hooks.BEFORE_SWAP_FLAG | Hooks.AFTER_SWAP_FLAG)));
        Hooks.validateHookPermissions(
            hookAddr,
            Hooks.Permissions({
                beforeInitialize: false,
    ...
    function test_fuzz_validateHookPermissions_beforeAndAfterDonate(uint160 addr) public view {
        uint160 preAddr = addr & clearAllHookPermissionsMask;
        IHooks hookAddr =
            IHooks(address(uint160(preAddr | Hooks.BEFORE_DONATE_FLAG | Hooks.AFTER_DONATE_FLAG)));
        Hooks.validateHookPermissions(
            hookAddr,
            Hooks.Permissions({
                beforeInitialize: false,
    ...
    function test_fuzz_validateHookAddress_failsAllHooks(uint160 addr, uint16 mask) public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Hooks.HookAddressNotValid.selector, (address(hookAddr)))
        );
        Hooks.validateHookPermissions(
            hookAddr,
            Hooks.Permissions({
    ...
    function test_isValidHookAddress_valid_anyFlags() public pure {
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000002000), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000001000), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000800), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000400), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000200), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000100), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000080), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000040), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000020), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0x0000000000000000000000000000000000000010), 3000)
        );
        assertTrue(
            Hooks.isValidHookAddress(IHooks(0xF00040A85D5Af5BF1d1762f925BdAddc42013C00), 3000)
        );
    }
    ...
    function test_fuzz_isValidHookAddress_invalid_returnsDeltaWithoutHookFlag(uint160 addr)
        public
        view
    {
        uint160 preAddr = addr & clearAllHookPermissionsMask;
        ...
        assertFalse(Hooks.isValidHookAddress(hookAddr, 3000));
        hookAddr =
            IHooks(address(uint160(preAddr | Hooks.AFTER_REMOVE_LIQUIDITY_RETURNS_DELTA_FLAG)));
        assertFalse(Hooks.isValidHookAddress(hookAddr, 3000));
    }
    ...
    function test_isValidHookAddress_valid_noFlagsWithDynamicFee() public pure {
        assertTrue(
            Hooks.isValidHookAddress(
                IHooks(0x1000000000000000000000000000000000000000), LPFeeLibrary.DYNAMIC_FEE_FLAG
            )
        );
    }
    ...
    function test_isValidHookAddress_invalid_noFlagsNoDynamicFee() public pure {
        assertFalse(
            Hooks.isValidHookAddress(IHooks(0x1000000000000000000000000000000000000000), 3000)
        );
        assertFalse(
            Hooks.isValidHookAddress(IHooks(0x0001000000000000000000000000000000004000), 3000)
        );
        assertFalse(
            Hooks.isValidHookAddress(IHooks(0x003840A85D5AF5bf1D1762F925BDaDdc42010000), 3000)
        );
        // not dynamic as another bit is dirty in the fee
        assertFalse(
            Hooks.isValidHookAddress(
                IHooks(0x1000000000000000000000000000000000000000),

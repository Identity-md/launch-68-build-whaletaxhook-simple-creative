...
contract SqrtPriceMathTest is Test {
    ...
    function test_getNextSqrtPriceFromInput_returnsInputPriceIfAmountInIsZeroAndZeroForOneEqualsTrue()
        public
        pure
    {
    ...
    function test_getNextSqrtPriceFromInput_returnsInputPriceIfAmountInIsZeroAndZeroForOneEqualsFalse()
        public
        pure
    {
        uint160 price = Constants.SQRT_PRICE_1_1;
    ...
    function test_getNextSqrtPriceFromInput_returnsTheMinimumPriceForMaxInputs() public pure {
        ...
        assertEq(
            SqrtPriceMath.getNextSqrtPriceFromInput(sqrtP, liquidity, maxAmountNoOverflow, true), 1
        );
    }
    ...
    function test_getNextSqrtPriceFromInput_amountInGreaterThanType_uint96_maxAndZeroForOneEqualsTrue()
        public
        pure
    {
        uint160 sqrtP = Constants.SQRT_PRICE_1_1;
        ...
        uint160 sqrtQ =
            SqrtPriceMath.getNextSqrtPriceFromInput(sqrtP, uint128(10 ether), 2 ** 100, true);
    ...
    function test_getNextSqrtPriceFromInput_canReturn1WithEnoughAmountInAndZeroForOneEqualsTrue()
        public
        pure
    {
        uint160 sqrtP = Constants.SQRT_PRICE_1_1;
        ...
        uint160 sqrtQ =
            SqrtPriceMath.getNextSqrtPriceFromInput(sqrtP, 1, Constants.MAX_UINT256 / 2, true);
    ...
    function test_getNextSqrtPriceFromOutput_revertsIfOutputAmountIsExactlyTheVirtualReservesOfCurrency0()
        public
    {
    ...
    function test_getNextSqrtPriceFromOutput_revertsIfOutputAmountIsGreaterThanTheVirtualReservesOfCurrency0()
        public
    {
        uint160 price = 20282409603651670423947251286016;
        uint128 liquidity = 1024;
    ...
    function test_getNextSqrtPriceFromOutput_revertsIfOutputAmountIsGreaterThanTheVirtualReservesOfCurrency1()
        public
    {
        uint160 price = 20282409603651670423947251286016;
        uint128 liquidity = 1024;
    ...
    function test_getNextSqrtPriceFromOutput_revertsIfOutputAmountIsExactlyTheVirtualReservesOfCurrency1()
        public
    {
        uint160 price = 20282409603651670423947251286016;
        uint128 liquidity = 1024;
    ...
    function test_getNextSqrtPriceFromOutput_returnsInputPriceIfAmountInIsZeroAndZeroForOneEqualsTrue()
        public
        pure
    {
        uint160 sqrtP = Constants.SQRT_PRICE_1_1;
    ...
    function test_getNextSqrtPriceFromOutput_returnsInputPriceIfAmountInIsZeroAndZeroForOneEqualsFalse()
        public
        pure
    {
        uint160 sqrtP = Constants.SQRT_PRICE_1_1;
        ...
        uint256 sqrtQ =
            SqrtPriceMath.getNextSqrtPriceFromOutput(sqrtP, uint128(0.1 ether), 0, false);
    ...
    function test_getNextSqrtPriceFromOutput_revertsIfAmountOutIsImpossibleInZeroForOneDirection()
        public
    {
        uint160 sqrtP = Constants.SQRT_PRICE_1_1;
    ...
    function test_getNextSqrtPriceFromOutput_revertsIfAmountOutIsImpossibleInOneForZeroDirection()
        public
    {
        uint160 sqrtP = Constants.SQRT_PRICE_1_1;
    ...
    function test_getAmount0Delta_returns0IfLiquidityIs0() public pure {
        uint256 amount0 = SqrtPriceMath.getAmount0Delta(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_2_1, 0, true
        );
    ...
    function test_getAmount0Delta_returns0IfPricesAreEqual() public pure {
        uint256 amount0 = SqrtPriceMath.getAmount0Delta(
            Constants.SQRT_PRICE_1_1, Constants.SQRT_PRICE_1_1, 0, true
        );
    ...
    function test_getAmount0Delta_worksForPricesThatOverflow() public pure {
        ...
        uint256 amount0Down =
            SqrtPriceMath.getAmount0Delta(sqrtP_1, sqrtP_2, uint128(1 ether), false);
    ...
    function test_getAmount0Delta_gasCostForAmount0WhereRoundUpIsTrue() public {
        ...
        SqrtPriceMath.getAmount0Delta(
            Constants.SQRT_PRICE_121_100, Constants.SQRT_PRICE_1_1, uint128(1 ether), true
        );
        vm.stopSnapshotGas();
    }
    ...
    function test_getAmount0Delta_gasCostForAmount0WhereRoundUpIsFalse() public {
        ...
        SqrtPriceMath.getAmount0Delta(
            Constants.SQRT_PRICE_121_100, Constants.SQRT_PRICE_1_1, uint128(1 ether), false
        );
        vm.stopSnapshotGas();
    }

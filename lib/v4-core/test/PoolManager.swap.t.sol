    ...
    IUniswapV3SwapCallback
{
    ...
    function addLiquidity(
        ...
        ModifyLiquidityParams memory v4LiquidityParams =
        ...
        returns (int256 amount0Diff, int256 amount1Diff)
    {
        ...
        if (
            amount0Delta > type(int128).max || amount1Delta > type(int128).max
                || amount0Delta < type(int128).min || amount1Delta < type(int128).min
        ) {
            overflows = true;
        }
        // v4 swap

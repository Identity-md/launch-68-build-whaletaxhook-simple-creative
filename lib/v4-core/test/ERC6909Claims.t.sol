...
contract ERC6909ClaimsTest is Test {
    ...
    function test_burnFrom_withApproval(
        address sender,
        uint256 id,
        uint256 mintAmount,
        ...
        if (transferAmount <= mintAmount) {
            if (mintAmount == type(uint256).max) {
                ...
                if (sender != address(this)) {
                    assertEq(
                        token.allowance(sender, address(this), id), mintAmount - transferAmount
                    );
                } else {
    ...
    function test_revertTransferBalanceUnderflow(
        address sender,
        address receiver,
        uint256 id,
        uint256 amount
    ...
    function test_revertTransferBalanceOverflow(
        address sender,
        address receiver,
        uint256 id,
        uint256 amount
    ...
    function test_revertTransferFromBalanceUnderflow(
        address sender,
        address receiver,
        uint256 id,
        uint256 amount
    ...
    function test_revertTransferFromBalanceOverflow(
        address sender,
        address receiver,
        uint256 id,
        uint256 amount
    ...
    function test_revertTransferFromNotAuthorized(
        address sender,
        address receiver,
        uint256 id,
        uint256 amount

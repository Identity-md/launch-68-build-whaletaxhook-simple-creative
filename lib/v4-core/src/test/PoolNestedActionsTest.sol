...
contract NestedActionExecutor is Test, PoolTestBase {
    ...
    SwapParams internal SWAP_PARAMS = SwapParams({
        zeroForOne: true, amountSpecified: -100, sqrtPriceLimitX96: Constants.SQRT_PRICE_1_2
    });
    ...
    function _swap(address caller) internal {
        ...
        assertEq(
            deltaThisBefore0 + SWAP_PARAMS.amountSpecified, deltaThisAfter0, "Executor delta 0"
        );

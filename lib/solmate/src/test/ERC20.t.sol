...
contract ERC20Test is DSTestPlus {
    ...
    function testFailBurnInsufficientBalance(address to, uint256 mintAmount, uint256 burnAmount)
        public
    {
    ...
    function testFailTransferInsufficientBalance(address to, uint256 mintAmount, uint256 sendAmount)
        public
    {
    ...
    function testFailTransferFromInsufficientAllowance(address to, uint256 approval, uint256 amount)
        public
    {
    ...
    function testFailPermitReplay(uint256 privateKey, address to, uint256 amount, uint256 deadline)
        public
    {
        if (deadline < block.timestamp) deadline = block.timestamp;
        if (privateKey == 0) privateKey = 1;

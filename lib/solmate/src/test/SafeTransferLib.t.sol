...
contract SafeTransferLibTest is DSTestPlus {
    ...
    function testTransferFromWithNonContract() public {
        SafeTransferLib.safeTransferFrom(
            ERC20(address(0xBADBEEF)), address(0xFEED), address(0xBEEF), 1e18
        );
    }
    ...
    function testFailTransferWithReverting(address to, uint256 amount, bytes calldata brutalizeWith)
        public
        brutalizeMemory(brutalizeWith)
    {
    ...
    function testFailApproveWithReverting(address to, uint256 amount, bytes calldata brutalizeWith)
        public
        brutalizeMemory(brutalizeWith)
    {
    ...
    function testFailApproveWithReturnsTwo(address to, uint256 amount, bytes calldata brutalizeWith)
        public
        brutalizeMemory(brutalizeWith)
    {

...
contract MultiRolesAuthorityTest is DSTestPlus {
    ...
    function testSetTargetCustomAuthority() public {
        ...
        assertEq(
            address(multiRolesAuthority.getTargetCustomAuthority(address(0xBEEF))), address(0xCAFE)
        );
    ...
    function testSetTargetCustomAuthority(address user, Authority customAuthority) public {
        ...
        assertEq(
            address(multiRolesAuthority.getTargetCustomAuthority(user)), address(customAuthority)
        );
    ...
    function testCanCallWithCustomAuthority(address user, address target, bytes4 functionSig)
        public
    {
        assertFalse(multiRolesAuthority.canCall(user, target, functionSig));
